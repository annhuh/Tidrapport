...
namespace Tidrapport.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ProjectId,Number,Name,StartDate,EndDate,CustomerId")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ProjectId,Number,Name,StartDate,EndDate,CustomerId")] Project project)
        {
            if (ModelState.IsValid)
            {
