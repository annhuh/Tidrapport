namespace Tidrapport.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.FlexDateBalances",
                c => new
                    {
                        EmployeeId = c.Int(nullable: false),
                        Date = c.DateTime(nullable: false),
                        NormalHours = c.Decimal(nullable: false, precision: 18, scale: 2),
                        ReportedHours = c.Decimal(nullable: false, precision: 18, scale: 2),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.FlexDateBalances", "EmployeeId", "dbo.Employees");
            ...
            DropIndex("dbo.FlexDateBalances", new[] { "EmployeeId" });
            ...
            DropTable("dbo.FlexDateBalances");
